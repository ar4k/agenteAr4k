...
<ul class="nav navbar-top-links navbar-right">
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-tasks">
            ...
            <li>
                <a class="text-center" href="#">
                    <strong>Vesualizza tutti i task</strong>
                    <i class="fa fa-angle-right"></i>
                </a>
            </li>
        </ul>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-alerts">
            ...
            <li>
                <a href="#">
                    <div>
                        <i class="fa fa-twitter fa-fw"></i> 3 Nuovi Iscritti
            ...
            <li>
                <a href="#">
                    <div>
                        <i class="fa fa-tasks fa-fw"></i> Nuove Lavorazione
                        <span class="pull-right text-muted small">4 minuti fa</span>
                    </div>
                </a>
            </li>
            ...
            <li>
                <a href="#">
                    <div>
                        <i class="fa fa-upload fa-fw"></i> Server Riavviato
                        <span class="pull-right text-muted small">4 minuti fa</span>
                    </div>
                </a>
            </li>
            ...
            <li>
                <a class="text-center" href="#">
                    <strong>Vedi tutti gli allarmi</strong>
                    <i class="fa fa-angle-right"></i>
                </a>
            </li>
        </ul>
